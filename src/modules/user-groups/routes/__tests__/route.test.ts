...
vi.mock('@Modules/user-groups/application/listUserGroups', () => ({
	listUserGroups: vi.fn(),
}));
vi.mock('@Modules/user-groups/application/getUserGroupById', () => ({
	getUserGroupById: vi.fn(),
}));
vi.mock('@Modules/user-groups/application/updateUserGroup', () => ({
	updateUserGroup: vi.fn(),
}));
vi.mock('@Modules/user-groups/application/deleteUserGroup', () => ({
