...
export const DOCUMENT_TYPES: DocumentTypeDef[] = [
	...
	},
	{
		value: 'CE',
		label: {
			es: 'Carné de extranjería',
			en: 'Foreign ID',
			de: 'Aufenthaltstitel',
			fr: 'Titre de séjour',
			it: 'Permesso di soggiorno',
			pt: 'Carteira de estrangeiro',
			ja: '外国人登録証',
			ko: '외국인 등록증',
			zh: '外籍居留证',
...
export const INDUSTRIES: IndustryDef[] = [
	...
	},
	{
		...
		label: {
			...
			it: 'Media & Intrattenimento',
			pt: 'Mídia & Entretenimento',
			ja: 'メディア・エンターテインメント',
			ko: '미디어 및 엔터테인먼트',
			zh: '媒体与娱乐',
			ru: 'СМИ и развлечения',
		},
	},
	{
	...
	},
	{
		...
		label: {
			...
			en: 'Nonprofit',
			de: 'Gemeinnützig',
			fr: 'Organisme à but non lucratif',
			it: 'Non profit',
