export const AUDIT_ACTIONS = {
	...
	COUPONS_UPDATED: 'coupons:updated',
	COUPONS_SOFT_DELETED: 'coupons:soft_deleted',
	COUPONS_PERMANENTLY_DELETED: 'coupons:permanently_deleted',
	COUPONS_RESTORED: 'coupons:restored',
