...
export function welcomeEmailTemplate({
	...
	return {
		subject: t(locale, 'welcomeEmail.subject', { appName }),
		html: `
<!DOCTYPE html>
<html lang="${lang}">
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1);">
        ...
        <tr><td style="padding:40px;">
          <h2 style="margin:0 0 16px;color:#111827;font-size:20px;">${t(locale, 'welcomeEmail.heading', { firstName: safeFirstName })}</h2>
